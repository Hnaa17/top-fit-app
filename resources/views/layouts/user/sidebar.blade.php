                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarAuth">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="#member" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="member" data-key="t-member"> Member
                                </a>
                                <div class="collapse menu-dropdown" id="member">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="" class="nav-link" data-key="t-verified"> Terverifikasi </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="" class="nav-link" data-key="t-notverified"> Belum Terverifikasi </a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="" class="nav-link" data-key="t-admin"> Admin </a>
                            </li>
